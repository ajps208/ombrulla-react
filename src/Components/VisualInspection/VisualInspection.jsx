        ...
        <div className="md:flex rounded-xl w-11/12 px-8 py-6">
          ...
          <div className="flex flex-col">
            <div className="flex items-center">
              ...
              <p className="ms-2"><b>AI VISUAL INSPECTION</b></p>
            </div>
            <div>
            ...
            <div  className="eighteenpx text-justify mt-5 md:text-xl">
              <ul>
                ...
                <li className="list-disc mt-2">
                  <b>Informed Decision-Making:</b>The system classNameifies defects,
                  aiding manufacturers in quality control decisions.
                </li>
                <li className="list-disc mt-2">
