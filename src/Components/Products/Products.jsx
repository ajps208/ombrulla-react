        ...
        <div className="md:flex rounded-xl w-11/12 px-8 py-6">
          <div className="flex flex-col">
            <div className="flex items-center">
              ...
              <p className="ms-2"><b>PRODUCTS</b></p>
            </div>
          ...
          <div className="flex flex-col bg-slate-100 rounded-lg mt-10 px-8 py-8">
            <div className="flex flex-col items-center">
              <h2 className="text-2xl font-semibold">Job Grading and Evaluation</h2>
              <p className="mt-3 font-medium text-gray-500">
              ...
              <p className="-ms-44 mt-4">
                ...
                <sup
                  ><i
                    className="fa-solid fa-arrow-up-right-from-square  text-blue-600"
                  ></i></sup>
              </p>
            </div>
          </div>
          <div
            className="flex flex-col md:ms-10 bg-slate-100 rounded-lg mt-10 px-8 py-8"
          >
            <div className="flex flex-col items-center">
              <h2 className="text-2xl font-semibold">Compensation Management</h2>
              <p className="mt-3 font-medium text-gray-500">
              ...
              <p className="-ms-32 mt-4">
                ...
                <sup
                  ><i
                    className="fa-solid fa-arrow-up-right-from-square text-blue-600"></i></sup>
              </p>
            </div>
          </div>
        </div>
