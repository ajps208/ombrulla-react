    ...
    <>
      <div className="dvh mt-8 testimonials p-3 md:px-20 flex flex-col gap-y-20 gap-x-7 bg-[#001a53] text-white">
        <div className="mt-8">
          ...
          <h3 className="md:text-4xl text-3xl font-medium">
        ...
        <div className="scrollable-cards-container overflow-x-auto">
          <div className="cards flex gap-x-4 overflow-x-auto">
            ...
            <div className="max-w-[40rem] flex items-center justify-center">
              <div className="card bg-white md:w-[40rem] w-[18rem] rounded-lg">
                <div className="p-9">
                  ...
                  <p className="text-[#82858d] font-normal text-lg">
            ...
            <div className="max-w-[40rem] flex items-center justify-center">
              <div className="card bg-white md:w-[40rem] w-[18rem] rounded-lg">
                <div className="p-9">
                  ...
                  <p className="text-[#82858d] font-normal text-lg">
                    Ombrulla has exceeded our expectations; they are serious and
                    consistent in their job. Ombrulla and their team of
            ...
            <div className="max-w-[40rem] flex items-center justify-center">
              <div className="card bg-white md:w-[40rem] w-[18rem] rounded-lg">
                <div className="p-9">
                  ...
                  <p className="text-[#82858d] font-normal text-lg">
                    We would like to express our gratitude for the collaboration
            ...
            <div className="max-w-[40rem] flex items-center justify-center">
              <div className="card bg-white md:w-[40rem] w-[18rem] rounded-lg">
                <div className="p-9">
                  ...
                  <p className="text-[#82858d] font-normal text-lg">
                    Ombrulla's AI-based Employee and Visitor Tracking System has
                    significantly enhanced our workplace operations, seamlessly
                    integrating security and productivity. This implementation
                    has made our organization more efficient and effective.
                  </p>
                </div>
                <div className="text-sm bg-slate-300 md:p-9 p-2 rounded-b-lg flex items-center gap-x-6">
              ...
              <div className="card bg-white md:w-[40rem] w-[18rem] rounded-lg">
                <div className="p-9">
                  ...
                  <p className="text-[#82858d] font-normal text-lg">
                    ...
                    collaboration with Ombrulla for the execution of scratch and
                    damage detection in cars. We extend our heartfelt gratitude
                    to Ombrulla for their invaluable support throughout this
                    project.
                  </p>
                </div>
                <div className="text-sm bg-slate-300 md:p-9 p-2 rounded-b-lg flex items-center gap-x-6">
            ...
            <div className="max-w-[40rem] flex items-center justify-center">
              <div className="card bg-white md:w-[40rem] w-[18rem] rounded-lg">
                <div className="p-9">
                  ...
                  <p className="text-[#82858d] font-normal text-lg">
                    Ombrulla and Green Palm collaborate on an AI ship inspection
                    project, employing image and video analysis to detect
                    damages and anomalies. We are highly satisfied with the
                    project's outcomes and the benefits it brings.
                  </p>
                </div>
                <div className="text-sm bg-slate-300 md:p-9 p-2 rounded-b-lg flex items-center gap-x-6">
                  <div className="card-logo w-[2rem] h-[2rem] md:w-[5rem] md:h-[5rem] rounded-full overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div
                className="left-5 overlay-button flex items-center justify-center bg-slate-600 text-white rounded-full w-[3rem] h-[3rem] cursor-pointer"
                onclick="scrollCards('left')"
              >
                <i className="fa-solid fa-chevron-left"></i>
              </div>
              <div
                className="right-5 overlay-button flex items-center justify-center bg-slate-600 text-white rounded-full w-[3rem] h-[3rem] cursor-pointer"
